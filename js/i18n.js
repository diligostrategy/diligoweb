...
const I18N = {
  ...
  dict: {
    en: {
      ...
      'r3.title': 'AI Content Tools Guide 2026', 'r3.desc': 'A curated list of the best AI tools for content creation, with pros, cons, and use cases.',
      ...
      'lead.newsletter': 'Also subscribe me to the newsletter',
      'footer.nl.title': 'Stay Updated',
      'footer.nl.desc': 'Get content marketing tips, industry insights, and exclusive resources delivered to your inbox.',
    ...
    es: {
      ...
      'r3.title': 'Guía de Herramientas AI 2026', 'r3.desc': 'Lista curada de las mejores herramientas AI para creación de contenido, con pros, contras y casos de uso.',
      ...
      'lead.newsletter': 'También suscribirme al newsletter',
      'footer.nl.title': 'Mantente Actualizado',
      'footer.nl.desc': 'Recibe tips de marketing de contenido, insights del sector y recursos exclusivos en tu bandeja.',
